...
function jsPathTo(text, offset, nonQuotedKeyRegex = DEFAULT_NON_QUOTED_KEY_REGEX) {
    ...
    try {
        ...
        if (e == "Ok")
            return pathToString(path, nonQuotedKeyRegex);
        throw e;
    }
    return "";
}
exports.jsPathTo = jsPathTo;
function pathToString(path, nonQuotedKeyRegex) {
    let s = '';
